...
class UcsCentralSession(object):
    ...
    def __init__(self, ip, username, password, port=None, secure=None,
        ...
        self.__driver = UcsCentralDriver(proxy=self.__proxy)
    ...
    def file_upload(self, url_suffix, file_dir, file_name):
        ...
        from .ucscentralgenutils import upload_file
    ...
    def _refresh(self, auto_relogin=False):
        ...
        from .ucscentralmethodfactory import aaa_refresh
    ...
    def _login(self, auto_refresh=False, force=False):
        ...
        if response.out_version is None or response.out_version == "":
            ...
            self._version = UcsCentralVersion(firmware.version)
    ...
    def _logout(self):
        ...
        from .ucscentralmethodfactory import aaa_logout
