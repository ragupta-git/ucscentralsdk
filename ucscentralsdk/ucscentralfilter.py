...
from .ucscentralfiltertype import OrFilter, AndFilter, NotFilter
from .ucscentralbasetype import FilterFilter
...
def handle_filter_max_component_limit(handle, l_filter):
    ...
    from .ucscentralcore import AbstractFilter
    from .ucscentralfiltertype import AndFilter, OrFilter
...
def create_basic_filter(filter_name, **kwargs):
    ...
    fq_module_name = ucscentralmeta.OTHER_TYPE_CLASS_ID[filter_name]
