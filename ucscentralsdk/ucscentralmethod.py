...
class ExternalMethod(UcsCentralBase):
    ...
    def __init__(self, method_id):
        # """ __init__ of the UcsCentralBase class """
        UcsCentralBase.__init__(self, method_id)

        meta_module = ucscentralcoreutils.load_module(method_id)
            ...
            for child_elem in child_elems:
                ...
                if child_name in self.__property_map:
                    ...
                    if method_prop_meta.inp_out == "Output" and \
                            method_prop_meta.is_complex_type:
                        child_obj = ucscentralcoreutils.get_ucs_central_obj(
