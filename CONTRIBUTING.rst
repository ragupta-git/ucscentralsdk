...
Ready to contribute? Here's how to set up `ucscentralsdk` for local development.

1. Fork the `ucscentralsdk` repo on GitHub.
2. Clone your fork locally::

    $ git clone git@github.com:your_name_here/ucscentralsdk.git

3. Install your local copy into a virtualenv. Assuming you have virtualenvwrapper installed, this is how you set up your fork for local development::

    $ mkvirtualenv ucscentralsdk
    $ cd ucscentralsdk/
...
3. The pull request should work for Python 2.6, 2.7, 3.3, and 3.4, and for PyPy. Check
   https://travis-ci.org/CiscoUcs/ucscentralsdk/pull_requests
...
To run a subset of tests::
    ...
    $ python -m unittest tests.test_ucscentralsdk
